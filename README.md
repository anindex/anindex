...
I'm an Assistant Professor at [VinUniversity](https://vinuni.edu.vn/) and a Visiting Professor at [IAS, TU Darmstadt](https://www.ias.informatik.tu-darmstadt.de/Team/AnThaiLe), where I also lead the AI team at [VinRobotics](https://vinrobotics.net/), focused on RL for humanoid locomotion, humanoid VLA architecture and training, and model deployment.
